// Hand-picked Lucide outline icons, inlined so the app works fully offline.
// All 24x24, stroke-based, consistent 2px weight.
(function () {
  const wrap = (paths) =>
  ...
  const ICONS = {
    ...
    'file-down': wrap('<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M12 18v-6"/><path d="m9 15 3 3 3-3"/>'),
    ...
    sparkle: wrap('<path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/>'),
    ...
    vault: wrap('<rect width="18" height="18" x="3" y="3" rx="3"/><circle cx="12" cy="12" r="4"/><path d="M12 8v1"/><path d="M12 15v1"/><path d="M8 12h1"/><path d="M15 12h1"/>')
  };
